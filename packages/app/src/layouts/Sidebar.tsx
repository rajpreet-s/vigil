...
import { Activity, Network, BookOpen, Cpu, User } from 'lucide-react';
import { useApp } from '../context/AppContext';

export const Sidebar: React.FC = () => {
  const { incidents, connectionState, setConnectionState } = useApp();
  ...
  return (
    <aside className="w-64 bg-surface-container-low/60 backdrop-blur-md border-r border-surface-container-high/50 flex flex-col justify-between flex-shrink-0 z-10">
      ...
      {/* User Card */}
      <div className="p-4 border-t border-surface-container-high/40 bg-surface-container-low/30">
